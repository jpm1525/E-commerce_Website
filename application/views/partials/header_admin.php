...
<html lang="en">
    ...
    <body>
		<header class="navbar navbar-expand-lg navbar-dark bg-dark px-3 mb-4">
			...
			<a href="<?=base_url();?>/admin/orders" class="link-light mx-3 text-decoration-none">Orders</a>
			<a href="<?=base_url();?>/admin/admin_products" class="link-light mx-3 text-decoration-none">Product</a>
